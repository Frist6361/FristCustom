...
1️⃣ — Назначить нового владельца приватной комнаты

2️⃣ — Переименовать приватную комнату

3️⃣ — Задать лимит участников приватной комнаты

4️⃣ — Закрыть/Открыть приватную комнату

5️⃣ — Скрыть/Открыть приватную комнату

6️⃣ — Кикнуть пользователя из войса

7️⃣  — Добавить пользователя в white list канала

8️⃣ — Забрать права на канал""", color = disnake.Colour(0x2f3136))
    ...
    @commands.slash_command(name = 'приватки',description='Настройка приватных войсов')
    @commands.has_permissions(manage_messages = True, manage_channels = True)
    async def private_voice(
        self,
        inter,
        caty = commands.Param(name = 'категория', description = 'Название для категории. После подключения приватных войсов её можно будет изменить.'),
        channel = commands.Param(name = 'канал', description = 'Название канала при входе в который будет создаваться приватный канал.')
    ):
